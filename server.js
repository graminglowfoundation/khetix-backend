...
import personalDiaryRoutes from './routes/personalDiary.js';
import { sendFarmAlertToUser } from './utils/pushNotification.js';

const PORT    = process.env.PORT || 5000;
const NUM_CPUS = os.cpus().length;
const isDev   = process.env.NODE_ENV === 'development';
const DISABLE_CLUSTERING = process.env.DISABLE_CLUSTERING === 'true';

// ============================================
// CLUSTER: Use all CPU cores in production
// ============================================
// Note: Render runs single-process by default. Set DISABLE_CLUSTERING=true for Render
if (!isDev && cluster.isPrimary && !DISABLE_CLUSTERING) {
...
async function createApp() {
  ...
  app.use('/api/personal-diary', personalDiaryRoutes);
